      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          {MOTIVOS.map(m => (
            <button
              ...
              onClick={() => setMotivo(m)}
              style={{
                background: motivo === m ? '#00c85322' : '#161616',
                border: `1px solid ${motivo === m ? '#00c853' : '#222'}`,
                borderRadius: 8, padding: '9px 12px', color: motivo === m ? '#00c853' : '#999',
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          ...
          <button
            ...
            disabled={!motivo}
            style={{
              flex: 1, background: motivo ? '#00c853' : '#222', border: 'none',
